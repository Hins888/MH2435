...
#define LV_USE_DEMO_WIDGETS USE_OSS_LVGL_DEMO_WIDGETS

/*Demonstrate the usage of encoder and keyboard*/
#define LV_USE_DEMO_KEYPAD_AND_ENCODER USE_OSS_LVGL_DEMO_KEYPAD_ENCODER

/*Benchmark your system*/
#define LV_USE_DEMO_BENCHMARK USE_OSS_LVGL_DEMO_BENCHMARK

/*Render test for each primitives. Requires at least 480x272 display*/
#define LV_USE_DEMO_RENDER USE_OSS_LVGL_DEMO_RENDER

/*Stress test for LVGL*/
#define LV_USE_DEMO_STRESS USE_OSS_LVGL_DEMO_STRESS

/*Music player demo*/
#define LV_USE_DEMO_MUSIC USE_OSS_LVGL_DEMO_MUSIC
