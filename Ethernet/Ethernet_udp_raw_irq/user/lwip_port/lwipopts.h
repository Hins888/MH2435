...
#define PBUF_POOL_BUFSIZE  2000 //LWIP_MEM_ALIGN_SIZE(TCP_MSS+40+PBUF_LINK_ENCAPSULATION_HLEN+PBUF_LINK_HLEN)
...
/*
The megahunt allows computing and verifying the IP, UDP, TCP and ICMP checksums by hardware:
