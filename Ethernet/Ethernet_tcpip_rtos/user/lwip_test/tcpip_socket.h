#ifndef __TCPIP_SOCKET_H
#define __TCPIP_SOCKET_H

#include "mh2435.h"

//#include "socket_platform_datatype.h"
//#include "socket_platform_timer.h"
#define FAIL_RETURN             (-1)       /**< generic error. */
#define NET_EUNKNOWN_HOST       (-3000)
#define NET_ECONNECT            (-3001)
#define NET_ESEND               (-3002)
#define NET_ERECV               (-3003)
#define NET_ELISTEN             (-3004)
#define NET_EBIND               (-3005)
//#define NET_ESOCKET             (-3006)
#define NET_ESOCKET             (-3007)
#define NET_ESETOPT_TIMEOUT      (-3008)
...
{
    SOCKET_FLAGS_DEFAULT = 0,  //默认
    SOCKET_FLAGS_DONTWAIT = 1, //非阻塞调用
} SOCKET_TRANS_FLAGS_E;
