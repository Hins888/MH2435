...
#define USE_UVC_MJPEG                   1
   
//Image width
#define UVC_TARGET_WIDTH                800
#define UVC_TARGET_HEIGHT               600
   
#define UVC_UNCOMP_FRAME_SIZE           (UVC_TARGET_WIDTH * UVC_TARGET_HEIGHT * 2)

#if USE_UVC_MJPEG
#define UVC_CAPTURE_MODE                USBH_VIDEO_MJPEG
#define UVC_MAX_FRAME_SIZE              (200*1024)
#else
...
/** @defgroup USBH_VIDEO_CORE_Exported_Variables
  * @{
  */ 
extern VIDEO_HandleTypeDef   UVC_Machine ;
extern volatile VIDEO_HandleTypeDef *VIDEO_Handle;
extern USBH_Class_cb_TypeDef  UVC_cb;
/**
  * @}
  */ 
...
/** @defgroup USBH_VIDEO_CORE_Exported_FunctionsPrototype
  * @{
  */ 
USBH_Status USBH_VIDEO_SetFrequency (USB_OTG_CORE_HANDLE *pdev , void *phost, 
