...
#define USBHID_VENDOR_DEMO   1
#define USBHID_KEYBOARD_DEMO 2

#define USBHID_DEMO USBHID_KEYBOARD_DEMO

#if (USBHID_DEMO == USBHID_VENDOR_DEMO)

#define USBHID_VENDOR_BUFFER_REPORT_COUNT 16

extern void HIDVendorSetup(USBDeviceStruct* device);
extern void HIDVendorLoop(void);
#define HIDSetup HIDVendorSetup
#define HIDLoop  HIDVendorLoop

#elif (USBHID_DEMO == USBHID_KEYBOARD_DEMO)

typedef enum KeyCodeEnum_e {
    KEY_A             = 4,
    KEY_B             = 5,
    KEY_C             = 6,
    KEY_D             = 7,
...
extern void HIDKeyboardPressKey(char* keys);

extern void HIDKeyboardSetup(USBDeviceStruct* device);
#define HIDSetup HIDKeyboardSetup

extern void HIDKeyboardLoopPressKey(void);
#define HIDLoop  HIDKeyboardLoopPressKey
#endif
