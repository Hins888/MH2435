...
/** 
  ...
  */
#define SDIO_INIT_CLK_DIV                ((uint8_t)0xB0)
/** 
...
#define SD_SDIO_DMA_CLK                  RCC_AHB4Periph_DMA2
...
void SD_LowLevel_DeInit(void)
{
    ...
    GPIO_PinAFConfig(GPIOB, GPIO_PinSource4, GPIO_AF_MCO);
...
void SD_LowLevel_Init(void)
{
    ...
    GPIO_PinAFConfig(GPIOB, GPIO_PinSource0, GPIO_AF_SDIO);
    GPIO_PinAFConfig(GPIOB, GPIO_PinSource1, GPIO_AF_SDIO);
    GPIO_PinAFConfig(GPIOB, GPIO_PinSource2, GPIO_AF_SDIO);
    ...
    RCC_AHB4PeriphClockCmd(SD_SDIO_DMA_CLK, ENABLE);
}
...
{
	if (DMA_GetFlagStatus(SD_SDIO_DMA_STREAM, DMA_FLAG_TCIF))
	{
