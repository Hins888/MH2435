        ...
        if( pxTaskStatusArray != NULL )
        {
            ...
            //if( ulTotalRunTime > 0 )
            {
                ...
                for( x = 0; x < uxArraySize; x++ )
                {
                    ...
                    snprintf(tmp,127, "  state:%d %d\r\n", pxTaskStatusArray[ x ].eCurrentState, ulStatsAsPercentage);
                    CHECK_AND_ADD_BUFF;
