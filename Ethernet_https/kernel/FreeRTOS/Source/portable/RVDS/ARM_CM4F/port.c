...
#define SYSTICK_EACH_ADD        (1000 / configTICK_RATE_HZ) /*ms*/
/*
...
/*-----------------------------------------------------------*/
//#defne vPortSVCHandler SVC_Handler
 ...
 */
	...
	void vPortSetupTimerInterrupt( void )
	{
		...
		portNVIC_SYSTICK_LOAD_REG = ( configSYSTICK_CLOCK_HZ / 1000 ) - 1UL;
